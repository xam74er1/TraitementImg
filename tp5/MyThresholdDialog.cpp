...
MyThresholdDialog::MyThresholdDialog( 
	...
	const wxPoint& pos, const wxSize& size, long style , int min ,  int max ,  int actual) 
: wxDialog( parent, id, title, pos, size, style ){

	m_threshold = new wxSlider( this, wxID_ANY, actual, min, max, wxPoint(20,10), wxSize(100,50), wxSL_HORIZONTAL|wxSL_LABELS );
